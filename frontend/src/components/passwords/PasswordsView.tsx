...
import { getItemsByParentId, getRootPasswordGroups } from '../../data/mockData';
  ...
  useEffect(() => {
    const fetchItems = async () => {
      ...
      if (currentFolder) {
        ...
        fetchedItems = getItemsByParentId(currentFolder);
      } else {
        // At root level - show password groups
        fetchedItems = getRootPasswordGroups();
      }
